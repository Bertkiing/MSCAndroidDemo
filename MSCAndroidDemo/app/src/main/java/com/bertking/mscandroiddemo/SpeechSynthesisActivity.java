...
import com.example.administrator.voice.speech.setting.TtsSettings;
...
public class SpeechSynthesisActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String TAG = SpeechSynthesisActivity.class.getSimpleName();
    // 语音合成对象
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            case R.id.image_tts_set:
                Intent intent = new Intent(this, TtsSettings.class);
...
//			int code = mTts.synthesizeToUri(text, path, mTtsListener);
    ...
    private String getResourcePath(){
        ...
        tempBuffer.append(";");
        //发音人资源
        tempBuffer.append(ResourceUtil.generateResourcePath(this, ResourceUtil.RESOURCE_TYPE.assets, "tts/"+this.voicerLocal+".jet"));
