...
import com.example.administrator.voice.speech.setting.IatSettings;
import com.example.administrator.voice.speech.util.FucUtil;
import com.example.administrator.voice.speech.util.JsonParser;
 ...
 * “语音听见” 模块
 */
public class VoiceDictationActivity extends Activity implements OnClickListener {
    public static final String TAG = VoiceDictationActivity.class.getSimpleName();
    // 语音听写对象
