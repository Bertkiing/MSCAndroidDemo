...
import com.example.administrator.voice.speech.setting.UnderstanderSettings;
 ...
 * "语义理解" 模块
 */
public class SemanticUnderStandActivity extends AppCompatActivity implements View.OnClickListener {
    public static final String TAG = SemanticUnderStandActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semantic_under_stand);
    ...
    public void onClick(View view)
    {
        switch (view.getId()) {
            ...
            case R.id.image_understander_set:
                Intent intent = new Intent(this, UnderstanderSettings.class);
